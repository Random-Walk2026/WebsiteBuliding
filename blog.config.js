...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lamjin Cheung', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '数学专业本硕', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lamjinlab.com', // 网站地址
