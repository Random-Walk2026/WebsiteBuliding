...
module.exports = {
  ...
  CONTACT_WHATSAPP: process.env.NEXT_PUBLIC_CONTACT_WHATSAPP || '', // 你的WhatsApp地址 例如 https://wa.me/85212345678
  CONTACT_FEISHU: process.env.NEXT_PUBLIC_CONTACT_FEISHU || '', // 你的飞书地址，例如个人主页、群组邀请链接或表单链接
